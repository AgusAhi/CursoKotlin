...
@Composable
fun Unit20(modifier: Modifier = Modifier, navController: NavHostController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Button(onClick = { navController.navigate("Project96") }) { Text("Go to Project 96") }
        Button(onClick = { navController.navigate("Project97") }) { Text("Go to Project 97") }
