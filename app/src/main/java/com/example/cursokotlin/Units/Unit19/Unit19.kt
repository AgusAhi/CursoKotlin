...
@Composable
fun Unit19(modifier: Modifier = Modifier, navController: NavHostController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Button(onClick = { navController.navigate("Project94") }) { Text("Go to Project 94") }
        Button(onClick = { navController.navigate("Project95") }) { Text("Go to Project 95") }
