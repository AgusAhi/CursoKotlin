...
class Exercise28 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Project28(modifier = Modifier, navController = rememberNavController())
        }
    }
}
@Composable
fun Project28(modifier: Modifier = Modifier, navController: NavHostController) {
