...
class Exercise55 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Project55(modifier = Modifier, navController = rememberNavController()) // Llama a la función composable principal
        }
    }
}
...
fun Project55(modifier: Modifier = Modifier, navController: NavHostController) {
    ...
    Column(
        ...
        // Botón para generar la tabla de multiplicar
        Button(
            onClick = {
        ...
        // Mostrar la tabla de multiplicar si se generó correctamente
        if (showResult) {
